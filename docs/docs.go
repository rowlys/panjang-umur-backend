        ...
        "/chat/{friendId}/messages": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Friend's user ID (UUID)",
                        "name": "friendId",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Only return messages older than this RFC3339 timestamp (pagination cursor)",
                        "name": "before",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Max messages to return (default 50, capped at 100)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/reward.CreateRewardRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/rewards/shop/{giverId}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Reward giver's user ID (UUID)",
                        "name": "giverId",
                        "in": "path",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "models.Challenge": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/models.ChallengeStatus"
                },
                "title": {
                    "type": "string"
                },
